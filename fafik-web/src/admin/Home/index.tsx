...
const AdminHomeComponent = () => {
  ...
  return (
    <Fragment>
      ...
      <AdminHome>
        <WelcomeText>
          Cieszymy się, że jesteście. Dziękujemy za wybranie naszego portalu.
          <br />
          Poniżej znajduje się szablon strony, który wybraliście. Na tym etapie oraz później
          <br />
          (w zakładce "Ustawienia" w "Profil" w prawym górnym rogu) możecie zmienić ten wybór.
          <br />
          Aby przejść do etapu edytowania, należy opłacić abonament, wybierając okres ważności.
          <br />
        </WelcomeText>
        <ChoiceBox>
          <ThemeOptionBox>
            ...
            <SideThemePanel>
              ...
              <MainBox>
                <Feature>
                  ...
                  <FeatureDescription>Odliczanie, mapy, plan dnia, playlisty,<br/>
                    blog, przedstawienie, preferencje<br/>
                    prezentowe, kod QR, informacje<br/>
                    dodatkowe, samodzielna edycja</FeatureDescription>
                </Feature>
              </MainBox>
              <BottomDecoration />
            </SideThemePanel>
